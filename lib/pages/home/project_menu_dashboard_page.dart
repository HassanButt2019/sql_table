...
class ProjectMenuDashboardPage extends StatefulWidget {
  ...
  @override
  _ProjectMenuDashboardPageState createState() => _ProjectMenuDashboardPageState();
}
    ...
    return Scaffold(
      body: Container(
          child: GridView.builder(
            ...
            shrinkWrap: false,
            itemCount: Provider.of<DashboardProvider>(context,listen: false).projectMenuTableDetailList.length,
            gridDelegate:
            ...
            itemBuilder: (context, index) {
              Map map=Provider.of<DashboardProvider>(context,listen: false).projectMenuTableDetailList![index];
